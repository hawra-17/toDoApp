...
const user = { loggedIn: 1 }; //Real check later
...
const allOrgs = [ //Fetch
  {
    ...
    {
    orgId: "1",
    orgName: "To show how Long names will be displayed To show how Long name will be displayed9",
    type: "business",
    industry: "Health",
  },
  {
              ...
              >
                <View className="flex-1 justify-center items-center">
                  ...
                  <Text className="text-white text-sm">
                   ...
                   <Text style={{ fontFamily: "Poppins_700", textTransform: "capitalize" }}> {org.type} Organization</Text>
                  </Text>
